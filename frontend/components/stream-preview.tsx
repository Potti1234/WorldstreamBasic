...
export function StreamPreview({ isLive }: StreamPreviewProps) {
  return (
    <div className="bg-white rounded-lg p-4 shadow-sm">
      <h2 className="text-lg font-semibold text-gray-900 mb-3">Stream Preview</h2>
          ...
          <div className="text-white text-center">
            {isLive ? (
              <>
                ...
                <p className="text-sm text-gray-300">Your stream is broadcasting</p>
              </>
            ) : (
              <>
                <div className="w-16 h-16 bg-gray-700 rounded-full flex items-center justify-center mb-4 mx-auto">
                ...
                <p className="text-sm text-gray-300">Click "Go Live" to start streaming</p>
              </>
            )}
          </div>
        </div>
